...
| 부품명 | 수량 | 용도 | 참고 가격 |
|--------|------|------|----------|
| Arduino Uno (또는 호환보드) | 1 | 메인 컨트롤러 | ₩8,000 ~ ₩15,000 |
| OLED 디스플레이 128×64 I2C (SSD1306) | 1 | 메시지 출력 | ₩2,000 ~ ₩5,000 |
| 택트 스위치 (푸시버튼) | 1 | 작업 승인 | ₩100 ~ ₩500 |
| 브레드보드 | 1 | 부품 연결 | ₩1,000 ~ ₩3,000 |
| 점퍼 와이어 (암수) | 6줄 | 배선 | ₩1,000 ~ ₩2,000 |
| USB A-B 케이블 | 1 | PC ↔ Arduino 연결 | ₩2,000 ~ ₩5,000 |

> **총 예상 비용:** ₩14,000 ~ ₩30,000 (보유 부품에 따라 다름)
